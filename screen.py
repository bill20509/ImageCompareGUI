...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalFrame_2.setMaximumSize(QtCore.QSize(50, 16777215))
        ...
        self.horizontalFrame_3 = QtWidgets.QFrame(self.page)
        ...
        self.verticalLayout_8 = QtWidgets.QVBoxLayout(self.slider_page)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.verticalLayout_7 = QtWidgets.QVBoxLayout()
        self.verticalLayout_7.setObjectName("verticalLayout_7")
        self.label = QtWidgets.QLabel(self.slider_page)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 433, 378))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.diff_label = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.diff_label.setGeometry(QtCore.QRect(180, 160, 35, 10))
        ...
        self.file_b_info = QtWidgets.QLabel(self.file_details_page)
        self.file_b_info.setObjectName("file_b_info")
        self.horizontalLayout_8.addWidget(self.file_b_info)
        self.file_a_info = QtWidgets.QLabel(self.file_details_page)
        self.file_a_info.setObjectName("file_a_info")
        self.horizontalLayout_8.addWidget(self.file_a_info)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "slider_page"))
        self.diff_label.setText(_translate("MainWindow", "diff_page"))
        self.file_b_info.setText(_translate("MainWindow", "file_a_info"))
        self.file_a_info.setText(_translate("MainWindow", "file_b_info"))
