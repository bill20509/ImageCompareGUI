...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalFrame_4.setMaximumSize(QtCore.QSize(16777215, 50))
        ...
        self.file_details_button = QtWidgets.QPushButton(self.horizontalFrame_4)
        ...
        self.function_stacked_page = QtWidgets.QStackedWidget(self.horizontalFrame_5)
        ...
        self.horizontalFrame_7.setMaximumSize(QtCore.QSize(16777215, 50))
        self.horizontalFrame_7.setObjectName("horizontalFrame_7")
        self.horizontalLayout_11 = QtWidgets.QHBoxLayout(self.horizontalFrame_7)
        self.horizontalLayout_11.setObjectName("horizontalLayout_11")
        spacerItem6 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_11.addItem(spacerItem6)
        self.horizontalLayout_12 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_12.setObjectName("horizontalLayout_12")
        self.zoom_out_button_3 = QtWidgets.QPushButton(self.horizontalFrame_7)
        self.zoom_out_button_3.setObjectName("zoom_out_button_3")
        self.horizontalLayout_12.addWidget(self.zoom_out_button_3)
        self.amplify_ratio_label_3 = QtWidgets.QLabel(self.horizontalFrame_7)
        self.amplify_ratio_label_3.setObjectName("amplify_ratio_label_3")
        self.horizontalLayout_12.addWidget(self.amplify_ratio_label_3)
        self.zoom_in_button_3 = QtWidgets.QPushButton(self.horizontalFrame_7)
        self.zoom_in_button_3.setObjectName("zoom_in_button_3")
        self.horizontalLayout_12.addWidget(self.zoom_in_button_3)
        ...
        self.resolution_label_3 = QtWidgets.QLabel(self.horizontalFrame_7)
        self.resolution_label_3.setObjectName("resolution_label_3")
        self.horizontalLayout_11.addWidget(self.resolution_label_3)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 381, 316))
        ...
        self.resolution_label = QtWidgets.QLabel(self.horizontalFrame_3)
        self.resolution_label.setObjectName("resolution_label")
        self.horizontalLayout_5.addWidget(self.resolution_label)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 343, 316))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.diff_label = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.diff_label.setGeometry(QtCore.QRect(120, 100, 35, 10))
        ...
        self.verticalLayout_9.addWidget(self.file_a_label, 0, QtCore.Qt.AlignHCenter)
        self.scrollArea_4 = QtWidgets.QScrollArea(self.file_details_page)
        self.scrollArea_4.setWidgetResizable(True)
        self.scrollArea_4.setObjectName("scrollArea_4")
        self.scrollAreaWidgetContents_5 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_5.setGeometry(QtCore.QRect(0, 0, 167, 52))
        self.scrollAreaWidgetContents_5.setObjectName("scrollAreaWidgetContents_5")
        self.file_a_info = QtWidgets.QLabel(self.scrollAreaWidgetContents_5)
        self.file_a_info.setGeometry(QtCore.QRect(0, 0, 71, 21))
        self.file_a_info.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.file_a_info.setObjectName("file_a_info")
        ...
        self.scrollAreaWidgetContents_6.setGeometry(QtCore.QRect(0, 0, 166, 52))
        self.scrollAreaWidgetContents_6.setObjectName("scrollAreaWidgetContents_6")
        self.file_b_info = QtWidgets.QLabel(self.scrollAreaWidgetContents_6)
        self.file_b_info.setGeometry(QtCore.QRect(0, 0, 61, 21))
        self.file_b_info.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.file_b_info.setObjectName("file_b_info")
        ...
        self.function_stacked_page.setCurrentIndex(2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.file_details_button.setText(_translate("MainWindow", "File Details"))
        ...
        self.zoom_out_button_3.setText(_translate("MainWindow", "-"))
        self.amplify_ratio_label_3.setText(_translate("MainWindow", "100%"))
        self.zoom_in_button_3.setText(_translate("MainWindow", "+"))
        self.pushButton_7.setText(_translate("MainWindow", "Reset"))
        self.resolution_label_3.setText(_translate("MainWindow", "(0,0)"))
        ...
        self.resolution_label.setText(_translate("MainWindow", "(0,0)"))
        self.diff_label.setText(_translate("MainWindow", "diff_label"))
        self.file_a_info.setText(_translate("MainWindow", "file_a_info"))
        self.file_b_info.setText(_translate("MainWindow", "file_b_info"))
